...
const HelpTab = () => {
  return (
    <section className='about-tab'>
            <HelpCard src={'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/MetaMask_Fox.svg/2048px-MetaMask_Fox.svg.png'} title={'Metamask Secure Integration'} body={'This feature allows you to securely connect your MetaMask wallet, enabling you to interact with blockchain networks and perform transactions Seamlessly.'}/>
